    ...
    <div className="m-4 pb-10">
      ...
      <div className="mb-6">
        ...
        <p>
          ...
          función del tiempo <Katex tex="t" />?
        </p>
        <RadioGroup
        ...
        >
          <div className="mt-2 flex flex-col">
            ...
            <label className="mt-2 flex items-center">
              ...
              <span className="ml-2">
                <Katex tex="x(t) = V_{0} \sin(\theta) t" />
              </span>
            </label>
            <label className="mt-2 flex items-center">
              <RadioGroupItem value="c" />
              <span className="ml-2">
                <Katex tex="x(t) = V_{0} t" />
              </span>
            </label>
            <label className="mt-2 flex items-center">
              <RadioGroupItem value="d" />
              <span className="ml-2">
                <Katex tex="x(t) = V_{0} t - \frac{1}{2} g t^2" />
              </span>
            </label>
          </div>
        </RadioGroup>
      ...
      <div className="mb-6">
        ...
        <p>
          ...
          del mono en función del tiempo <Katex tex="t" />?
        </p>
        <RadioGroup
        ...
        >
          <div className="mt-2 flex flex-col">
            ...
            <label className="mt-2 flex items-center">
              <RadioGroupItem value="c" />
              <span className="ml-2">
                <Katex tex="y_m(t) = V_{0} \sin(\theta) t - \frac{1}{2} g t^2" />
              </span>
            </label>
            <label className="mt-2 flex items-center">
              <RadioGroupItem value="d" />
              <span className="ml-2">
                <Katex tex="y_m(t) = h + V_{0} \cos(\theta) t" />
              </span>
            </label>
          </div>
        </RadioGroup>
      ...
      <div className="mb-6">
        ...
        <p>
          ¿Cuál es la relación entre <Katex tex="\tan(\theta)" /> y las
        ...
        >
          <div className="mt-2 flex flex-col">
            ...
            <label className="mt-2 flex items-center">
              <RadioGroupItem value="c" />
              <span className="ml-2">
                <Katex tex="\tan(\theta) = \frac{V_0}{g}" />
              </span>
            </label>
            <label className="mt-2 flex items-center">
              <RadioGroupItem value="d" />
              <span className="ml-2">
                <Katex tex="\tan(\theta) = \frac{g}{V_0}" />
              </span>
            </label>
          </div>
        </RadioGroup>
      ...
      <div className="mb-6">
        ...
        <p>
          Si aumentamos la aceleración de la gravedad <Katex tex="g" />,
